...
export const AboutUs = () => {
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col"> {/* Garante que o Footer fique no final da página */}
      <Header />

      <div className="container mx-auto px-4 py-16 flex-grow"> {/* Centraliza o conteúdo e permite espaçamento */}
